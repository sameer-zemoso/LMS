...
public class PerimeterAssignmentRunner {
    ...
    public double getLargestPerimeterMultipleFiles() {
        ...
        for (File f : dr.selectedFiles()) {
            ...
            if (maxPerimeter < getPerimeter(s))
    ...
    public static void main (String[] args) {
        ...
        FileResource fr = new FileResource();
        Shape s = new Shape(fr);
        System.out.println("No.of Points: "+pr.getNumPoints(s));
        System.out.println("Average Length: "+pr.getAverageLength(s));
        System.out.println("Largest Side: "+pr.getLargestSide(s));
        System.out.println("Largest X-coordinate: "+pr.getLargestX(s));
